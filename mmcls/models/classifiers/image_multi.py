...
class ImageClassifier(BaseClassifier):
    ...
    def extract_feat(self, img,pdesc,bics,bts, stage='neck'):
        ...
        assert stage in ['backbone', 'neck', 'pre_logits'], \
            (f'Invalid output stage "{stage}", please choose from "backbone", '
             '"neck" and "pre_logits"')
        x = self.backbone(img,pdesc,bics,bts)
    ...
    def forward_train(self, img,pdesc,bics,bts, gt_label, **kwargs):
        ...
        x = self.extract_feat(img,pdesc,bics,bts)
        losses = dict()
    ...
    def simple_test(self, img,pdesc,bics,bts, img_metas=None, **kwargs):
