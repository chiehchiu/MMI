...
def train_model(model,
    ...
    num_per_ct = cfg.data.get('num_per_ct', 64)
    pos_fraction = cfg.data.get('pos_fraction', 0.5)
    logger.info("Using params num_per_ct = %d and pos_fraction=%.2f" % (num_per_ct, pos_fraction))  
    ...
    data_loaders = [
        build_dataloader(
            ...
            dist=distributed,
            sid_sampler=sid_sampler,
            round_up=True,
            seed=cfg.seed,
            num_per_ct=num_per_ct, 
